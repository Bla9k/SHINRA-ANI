...
export const SAMPLE_COLLECTIBLES: Collectible[] = [
  {
    ...
    originalMalId: 1575, // Code Geass R1
    originalType: 'anime',
    rarity: 'Forbidden',
  ...
  // ... (Previous sample collectibles up to ~100 as per last successful generation)
  // Batch 1 (from previous successful generation)
  {
  ...
  },
  {
    ...
    imageUrl: NO_ART_PLACEHOLDER, // Placeholder for evolved art
  ...
  // ... (End of Batch 1)
  // TODO: Add ~400 more unique entries to reach the 500+ goal.
  // The following are illustrative examples for continued expansion.
  // It's crucial to ensure originalMalId and originalType are plausible or accurate.
];
...
export const SAMPLE_PACKS: GachaPack[] = [
  ...
  },
  {
    ...
    collectibleIds: [
        ...
        'the-end-of-evangelion:-congratulations!-(everyone-turns-into-tang)', // Mythic
        'grave-of-the-fireflies:-you-will-cry.-that-s-it,-that-s-the-description.', // Mythic
        ...
        'chainsaw-man:-denji-really-needs-therapy-(and-a-hug)', // Mythic
        ...
        'chainsaw-man-movie:-rezebomb', // Event
        // You can add more specific Mythic and Event card IDs here
